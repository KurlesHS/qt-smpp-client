...
void SmppClient::handleDeliverSm(const QByteArray &pdu)
{
    ...
    if (esmClass & 0x04) {
        logMsg("delivery receipt received");
        // delivery receipt
            ...
            if (m_pendingDeliveryRequestMessages.contains(smppMessageId)) {
                ...
                if (tlv){
                    ...
                    case 0x06: // ACCEPTED
                        ...
                        break;
                    case 0x02: { // DELIVERED
                        emit smsStatusChanged(smppMessage.messageId(), Delivered);
                    ...
                    case 0x08: { // REJECTED
                        ...
                        break;
                    default: {
                        emit smsStatusChanged(smppMessage.messageId(), Unknown);
                        m_pendingDeliveryRequestMessages.remove(smppMessageId);
                    }
                        break;
                    }
